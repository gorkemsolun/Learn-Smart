  ...
  return (
    <div className="flex min-h-screen items-center justify-center">
      <Card className="relative flex h-[72vh] w-3/5 overflow-auto">
        ...
        <div className="border-1 bg-foreground/5 relative flex w-1/2 items-center justify-center space-y-4 rounded-l-lg p-4">
        ...
        <div className="flex w-1/2 flex-col items-center justify-center p-4">
          ...
          <CardContent className="flex w-full flex-col items-center justify-center">
            <div className="grid w-5/6 items-center gap-4">
              ...
              <Button
                className="border-input bg-background text-accent-foreground hover:bg-accent hover:text-accent-foreground focus-visible:ring-ring inline-flex
                  items-center justify-center space-x-2 whitespace-nowrap rounded-md
                  border px-4 py-2 text-sm font-medium shadow-sm transition-colors
