...
# Chat service's function for getting the current user. Implements the client stub for auth service
# Chat service Depends on this for authentication
async def chat_get_current_user(token: str = Depends(oauth2_scheme)):
